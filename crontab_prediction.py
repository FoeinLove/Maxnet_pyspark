...
kkk = kk.filter(~kk.val.rlike('-20\d{6}'))        .filter(~kk.val.rlike('^admin'))        .filter(~kk.val.rlike('^china'))        .filter(~kk.val.rlike('SC-[A-Z]{4}\d{4}\w{4}'))        .filter(~kk.val.rlike('^XYXS-20'))        .filter(~kk.val.rlike('20\d{10}'))        .filter(~kk.val.rlike('^YOS-'))        .filter(~kk.val.rlike('^WWW-'))        .filter(~kk.val.rlike('^LUKA-'))        .filter(~kk.val.rlike('^LRGM-'))
